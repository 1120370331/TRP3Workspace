...
Upstream source is held separately in `references/` as Git submodules. RPBox-derived evidence and snapshots live in `research/rpbox/`; neither directory is part of a deployable item.
```
...
| `research/rpbox/` | Preserved RPBox analysis and source snapshots | RPBox commit `8485f74be09f038218b54717101c6ab9beb81004` |
